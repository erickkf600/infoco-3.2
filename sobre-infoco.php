  ...
  <div class="container" id="container">
    <div class="welcome-area">
      <div class="title-area">
        <h1 class="tittle">Bem Vindo a <span>InFoco</span></h1>
          ...
          <ul class="wc-table">
            <li class="col-lg-3 col-md-6 col-sm-6">
              <div class="single-wc-content wow fadeInUp fhd">
                ...
                <h2 class="wc-tittle">Ganhe mais destaque</h2>
            ...
            <li class="col-lg-3 col-md-6 col-sm-6">
              <div class="single-wc-content wow fadeInUp fhd">
                ...
                <h2 class="wc-tittle">TENHA SEU PRÓPRIO SITE</h2>
            ...
            <li class="col-lg-3 col-md-6 col-sm-6">
              <div class="single-wc-content wow fadeInUp last fhd">
                ...
                <h2 class="wc-tittle">DESCONTOS EXCLUSIVOS</h2>
            ...
            <li class="col-lg-3 col-md-6 col-sm-6">
              <div class="single-wc-content wow fadeInUp">
                ...
                <h2 class="wc-tittle">NETWORKING</h2>
              ...
              <div class="about-right wow fadeInRight">
                <div class="title-area">
                  ...
                  <div class="about-btn-area">
                    <a href="adesao.php" class="button" title="Faça a sua adesão"><span>FAÇA A SUA ADESÃO</span></a>
                  </div>                    
                </div>
              </div>
            </div>
